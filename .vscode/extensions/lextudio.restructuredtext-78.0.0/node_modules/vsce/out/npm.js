...
function asYarnDependency(prefix, tree) {
    ...
    for (var _i = 0, _a = (tree.children || []); _i < _a.length; _i++) {
        var child = _a[_i];
        var dep = asYarnDependency(path.join(prefix, name, 'node_modules'), child);
        if (dep) {
            children.push(dep);
        }
    }
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    result = trees
                        .map(function (tree) { return asYarnDependency(path.join(cwd, 'node_modules'), tree); })
