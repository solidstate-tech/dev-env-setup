...
class RstDocumentContentProvider {
    ...
    provideTextDocumentContent(resource) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const rstTransformerConf = yield this.refreshConfig(uri);
            ...
            if (rstTransformerConf.confPyDirectory !== '') {
                ...
                if (!fs.existsSync(confFile)) {
                    return this.showError('Cannot find "conf.py". Please review "restructuredtext.confPath" setting.', 'Current "conf.py" setting is "' + confFile + '".');
                }
            }
            else {
    ...
    showStatus(uri, status) {
        return __awaiter(this, void 0, void 0, function* () {
            const setting = configuration_1.Configuration.loadSetting('confPath', null, uri);
            if (setting == null) {
                return;
            }
            const rstTransformerConf = yield this.getRstTransformerConfig(uri);
            status.setConfiguration(rstTransformerConf.label);
            status.update();
        });
    }
    resetRstTransformerConfig(uri) {
        return __awaiter(this, void 0, void 0, function* () {
            this._rstTransformerConfig = null;
            yield configuration_1.Configuration.saveSetting('confPath', undefined, uri);
            this.update(uri);
            if (!vscode_1.window.activeTextEditor) {
                return;
            }
            // we are relaxed and don't check for markdown files
            yield this.refreshConfig(vscode_1.window.activeTextEditor.document.uri);
        });
    }
    ...
    getRstTransformerConfig(resource) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    refreshConfig(resource) {
        return __awaiter(this, void 0, void 0, function* () {
            const rstTransformerConf = yield this.getRstTransformerConfig(resource);
            if (rstTransformerConf == null) {
                return null;
            }
            this._rstTransformerStatus.setConfiguration(rstTransformerConf.label);
            this._rstTransformerConfig = rstTransformerConf;
            yield configuration_1.Configuration.saveSetting('confPath', rstTransformerConf.confPyDirectory, resource);
